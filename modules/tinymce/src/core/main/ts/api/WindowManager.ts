...
interface WindowManager {
  ...
  openUrl: <T>(config: Dialog.UrlDialogSpec) => Dialog.UrlDialogInstanceApi;
...
export interface WindowManagerImpl {
  ...
  openUrl: <T>(config: Dialog.UrlDialogSpec, closeWindow: (dialog: Dialog.UrlDialogInstanceApi) => void) => Dialog.UrlDialogInstanceApi;
